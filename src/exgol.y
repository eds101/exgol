...
private void addRuleClassID(String i){
	//System.out.println("adding rule class " + i);
	ruleClassIDList.add(i);
}

private void addResolveID(String i){
	//System.out.println("adding rule resolve" + i);
	resolveIDList.add(i);
}
...
// Class restrictions working for rules ?
//add rule classes
	for (Enumeration e = ruleClassIDList.elements(); e.hasMoreElements();)
		{
			String ID = (String) e.nextElement();
